...
import com.huizhi.employee.common.*;
...
import com.huizhi.employee.model.dto.user.*;
import com.huizhi.employee.model.entity.User;
import com.huizhi.employee.model.vo.LoginUserVO;
...
import static com.huizhi.employee.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        // 为用户分配一个随机头像
        User user = new User();
        user.setUserAvatar("http://60.204.185.112:8101/api/images/"); // 设置头像路径
