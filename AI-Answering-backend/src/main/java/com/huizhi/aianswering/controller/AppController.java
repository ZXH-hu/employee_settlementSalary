...
import com.huizhi.aianswering.model.dto.app.AppAddRequest;
import com.huizhi.aianswering.model.dto.app.AppEditRequest;
import com.huizhi.aianswering.model.dto.app.AppQueryRequest;
import com.huizhi.aianswering.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        ...
        App app = new App();
        app.setId(id);
        app.setReviewStatus(reviewStatus);  // 审核状态
        app.setReviewMessage(reviewRequest.getReviewMessage()); // 审核信息
        app.setReviewerId(loginUser.getId());   // 审核人id
