...
import com.huizhi.aianswering.mapper.AppMapper;
import com.huizhi.aianswering.model.dto.app.AppQueryRequest;
...
import com.huizhi.aianswering.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            AppTypeEnum enumByType = AppTypeEnum.getEnumByValue(appType);
            ThrowUtils.throwIf(enumByType == null, ErrorCode.PARAMS_ERROR, "应用类型非法");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            // 需要拼接查询条件，如果从appName或者appDesc中描述有值
